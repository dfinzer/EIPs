...
Here is some example metadata that complies to the metadata spec. This example is for a sword inside of a game:

```
{
        "name": "Magic Sword",
        "description": "This magical sword can be used to fight dragons.",
